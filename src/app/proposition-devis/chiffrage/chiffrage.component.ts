...
import { Chiffrage } from '../../services/chiffrage/chiffrage';
import { ChiffrageService } from '../../services/chiffrage/chiffrage.service';
...
export class ChiffrageComponent {
  ...
  constructor(private chiffrageService: ChiffrageService) { }
